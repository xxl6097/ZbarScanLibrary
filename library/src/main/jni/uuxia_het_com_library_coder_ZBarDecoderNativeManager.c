 ...
 * -----------------------------------------------------------------
 *
 * File: uuxia_het_com_library_coder_ZBarDecoderNativeManager.java
 * Create: 2016/1/16 17:34
 */
#include <string.h>
#include <stdlib.h>
...
#include "zbar.h"
#include "uuxia_het_com_library_coder_ZBarDecoderNativeManager.h"
