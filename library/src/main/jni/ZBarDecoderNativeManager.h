...
#include <jni.h>
/* Header for class uuxia_het_zbar_library_coder_ZBarDecoderNativeManager */

#ifndef _Included_uuxia_het_zbar_library_coder_ZBarDecoderNativeManager
#define _Included_uuxia_het_zbar_library_coder_ZBarDecoderNativeManager
#ifdef __cplusplus
extern "C" {
#endif
/*
